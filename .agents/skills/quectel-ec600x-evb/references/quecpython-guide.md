...
本文档提供在 EC600X-EVB 上运行 QuecPython 的板载外设驱动示例与配置说明。开发板支持 EC600N-CN、EC600U-CN、EC600M-CN，本项目当前实装 EC600M-CN。
...
- **通信接口**:
  ...
  - J5 Pin 8 / 9 (TX2 / RX2)：UART2；具体用途按所装模组和固件确认。
...
光敏电阻连接在 J6 Pin 4 的 ADC0 输入端（模组引脚 19）。
